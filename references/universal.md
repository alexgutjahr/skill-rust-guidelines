...
**Applies to:** Universal — applies to all Rust code (libraries and applications)

**Source:** `src/guidelines/universal` in microsoft/rust-guidelines (pinned; see UPSTREAM.md)
