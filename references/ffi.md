...
**Applies to:** FFI — applies when the crate produces a cdylib/staticlib or uses extern "C"

**Source:** `src/guidelines/ffi` in microsoft/rust-guidelines (pinned; see UPSTREAM.md)
