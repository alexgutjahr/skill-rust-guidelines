...
**Applies to:** Safety — applies whenever unsafe is used; M-UNSOUND applies everywhere

**Source:** `src/guidelines/safety` in microsoft/rust-guidelines (pinned; see UPSTREAM.md)
