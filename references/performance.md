...
**Applies to:** Performance — applies whenever throughput or latency matters

**Source:** `src/guidelines/performance` in microsoft/rust-guidelines (pinned; see UPSTREAM.md)
